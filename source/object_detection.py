...
def annotate_image(
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > confidence_threshold:
            ...
            # overlay = image.copy()
            # cv2.rectangle(overlay, (start_x, start_y), (end_x, end_y), (0, 255, 0), -1)
            ...
            label_y = start_y - 15 if start_y - 15 > 15 else start_y + 15
            cv2.putText(image, label, (start_x, label_y), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
    return image
